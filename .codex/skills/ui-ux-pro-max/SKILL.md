...
This creates:
- `design-system/MASTER.md` — generated design-system baseline for the current project
...
2. If the page file exists, its rules refine the generated baseline for that page
