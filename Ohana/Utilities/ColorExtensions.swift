...
extension Color {
    ...
    static let ohanaPopupSurfaceFill = Color(light: Color.white.opacity(0.30), dark: Color.black.opacity(0.48)) // ui-v4: allow semantic popup glass dark readability tint
    static let ohanaPopupSurfaceStroke = Color(light: Color.black.opacity(0.08), dark: Color.white.opacity(0.18)) // ui-v4: allow semantic popup glass contrast stroke
