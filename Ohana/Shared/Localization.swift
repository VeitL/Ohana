...
nonisolated struct L10n {
    ...
    private static let curatedStaticTranslationsBase: [String: [String: String]] = [
        ...
        "喷水": ["es": "Rociar", "pt": "Borrifar", "fr": "Brumiser"],
        "换垫材": ["es": "Cambiar sustrato", "pt": "Trocar substrato", "fr": "Changer le substrat"],
        ...
        "清耳": ["es": "Orejas", "pt": "Orelhas", "fr": "Oreilles"],
        "梳毛": ["es": "Cepillado", "pt": "Escovação", "fr": "Brossage"],
        "洗澡": ["es": "Baño", "pt": "Banho", "fr": "Bain"],
        "完美": ["es": "Perfecta", "pt": "Perfeito", "fr": "Parfait"],
        "软便": ["es": "Blanda", "pt": "Mole", "fr": "Molles"],
        "水便": ["es": "Líquida", "pt": "Líquida", "fr": "Liquides"],
        "尿尿": ["es": "Pis", "pt": "Xixi", "fr": "Pipi"],
        "疫苗": ["es": "Vacuna", "pt": "Vacina", "fr": "Vaccin"],
        "驱虫": ["es": "Desparasitar", "pt": "Vermífugo", "fr": "Vermifuge"],
        "体检": ["es": "Revisión", "pt": "Consulta", "fr": "Visite"],
    ...
    private static let curatedStaticTranslationsExpansion: [String: [String: String]] = [
        ...
        "喷水": ["ja": "霧吹き", "ko": "분무", "it": "Nebulizza"],
        "换垫材": ["ja": "床材交換", "ko": "바닥재 교체", "it": "Cambia substrato"],
        ...
        "清耳": ["ja": "耳そうじ", "ko": "귀 청소", "it": "Orecchie"],
        "梳毛": ["ja": "ブラッシング", "ko": "빗질", "it": "Spazzola"],
        "洗澡": ["ja": "お風呂", "ko": "목욕", "it": "Bagno"],
        "完美": ["ja": "良好", "ko": "좋음", "it": "Perfetta"],
        "软便": ["ja": "軟便", "ko": "무른 변", "it": "Morbide"],
        "水便": ["ja": "水様便", "ko": "묽은 변", "it": "Liquide"],
        "尿尿": ["ja": "おしっこ", "ko": "소변", "it": "Pipì"],
        "疫苗": ["ja": "ワクチン", "ko": "백신", "it": "Vaccino"],
        "驱虫": ["ja": "駆虫", "ko": "구충", "it": "Sverminazione"],
        "体检": ["ja": "健診", "ko": "검진", "it": "Visita"],
    ...
    private static let curatedHumanProfileTranslations: [String: [String: String]] = [
        "、": ["es": ", ", "pt": ", ", "fr": ", ", "ja": "、", "ko": ", ", "it": ", "],
        "体重记录": ["es": "Registros de peso", "pt": "Registros de peso", "fr": "Historique du poids", "ja": "体重記録", "ko": "체중 기록", "it": "Registri del peso"],
        "全部公开": ["es": "Todo visible", "pt": "Tudo visível", "fr": "Tout est visible", "ja": "すべて表示", "ko": "모두 표시", "it": "Tutto visibile"],
        "删除": ["es": "Eliminar", "pt": "Excluir", "fr": "Supprimer", "ja": "削除", "ko": "삭제", "it": "Elimina"],
        "加入时间": ["es": "Fecha de incorporación", "pt": "Data de entrada", "fr": "Date d’ajout", "ja": "追加日", "ko": "추가한 날짜", "it": "Data di aggiunta"],
        "吃药提醒": ["es": "Recordatorios de medicación", "pt": "Lembretes de medicação", "fr": "Rappels de médicaments", "ja": "服薬リマインダー", "ko": "복약 알림", "it": "Promemoria farmaci"],
        "名字": ["es": "Nombre", "pt": "Nome", "fr": "Nom", "ja": "名前", "ko": "이름", "it": "Nome"],
        "国籍": ["es": "Nacionalidad", "pt": "Nacionalidade", "fr": "Nationalité", "ja": "国籍", "ko": "국적", "it": "Nazionalità"],
        "基础资料": ["es": "Perfil", "pt": "Perfil", "fr": "Profil", "ja": "プロフィール", "ko": "프로필", "it": "Profilo"],
        "头像": ["es": "Avatar", "pt": "Avatar", "fr": "Avatar", "ja": "アバター", "ko": "아바타", "it": "Avatar"],
        "头像 Emoji": ["es": "Emoji del avatar", "pt": "Emoji do avatar", "fr": "Emoji de l’avatar", "ja": "アバター絵文字", "ko": "아바타 이모지", "it": "Emoji avatar"],
        "好的": ["es": "Aceptar", "pt": "OK", "fr": "OK", "ja": "OK", "ko": "확인", "it": "OK"],
        "家庭与位置": ["es": "Familia y ubicación", "pt": "Família e localização", "fr": "Famille et lieu", "ja": "家族と所在地", "ko": "가족 및 위치", "it": "Famiglia e luogo"],
        "家庭角色": ["es": "Rol en el hogar", "pt": "Papel na família", "fr": "Rôle dans le foyer", "ja": "家族での役割", "ko": "가족 역할", "it": "Ruolo familiare"],
        "尚未填写": ["es": "Aún no añadido", "pt": "Ainda não adicionado", "fr": "Pas encore renseigné", "ja": "未入力", "ko": "아직 입력하지 않음", "it": "Non ancora aggiunto"],
        "已进入纪念状态": ["es": "Perfil conmemorativo", "pt": "Perfil memorial", "fr": "Profil commémoratif", "ja": "メモリアルプロフィール", "ko": "추모 프로필", "it": "Profilo commemorativo"],
        "微调 80-230 cm": ["es": "Ajustar entre 80 y 230 cm", "pt": "Ajustar entre 80 e 230 cm", "fr": "Ajuster entre 80 et 230 cm", "ja": "80〜230 cmで微調整", "ko": "80~230cm 미세 조정", "it": "Regola tra 80 e 230 cm"],
        "性别/身份": ["es": "Género / identidad", "pt": "Gênero / identidade", "fr": "Genre / identité", "ja": "性別・アイデンティティ", "ko": "성별 / 정체성", "it": "Genere / identità"],
        "成员名字": ["es": "Nombre del miembro", "pt": "Nome do membro", "fr": "Nom du membre", "ja": "メンバー名", "ko": "구성원 이름", "it": "Nome del membro"],
        "成员已删除，但其本地备注附件未能完全清理。请联系支持。": ["es": "El miembro se eliminó, pero algunos archivos adjuntos locales no pudieron borrarse. Contacta con soporte.", "pt": "O membro foi excluído, mas alguns anexos locais não puderam ser removidos. Entre em contato com o suporte.", "fr": "Le membre a été supprimé, mais certaines pièces jointes locales n’ont pas pu être effacées. Contactez l’assistance.", "ja": "メンバーは削除されましたが、ローカルのメモ添付ファイルを完全に消去できませんでした。サポートにお問い合わせください。", "ko": "구성원은 삭제되었지만 일부 로컬 메모 첨부 파일을 완전히 정리하지 못했습니다. 지원팀에 문의해 주세요.", "it": "Il membro è stato eliminato, ma alcuni allegati locali non sono stati rimossi. Contatta l’assistenza."],
        "撤销": ["es": "Deshacer", "pt": "Desfazer", "fr": "Annuler", "ja": "元に戻す", "ko": "실행 취소", "it": "Annulla"],
        "撤销离世标记": ["es": "Quitar estado conmemorativo", "pt": "Remover estado memorial", "fr": "Retirer le statut commémoratif", "ja": "逝去の記録を取り消す", "ko": "추모 상태 취소", "it": "Rimuovi lo stato commemorativo"],
        "放弃修改": ["es": "Descartar cambios", "pt": "Descartar alterações", "fr": "Ignorer les modifications", "ja": "変更を破棄", "ko": "변경 사항 버리기", "it": "Annulla modifiche"],
        "放弃未保存的修改？": ["es": "¿Descartar los cambios sin guardar?", "pt": "Descartar alterações não salvas?", "fr": "Ignorer les modifications non enregistrées ?", "ja": "未保存の変更を破棄しますか？", "ko": "저장하지 않은 변경 사항을 버릴까요?", "it": "Annullare le modifiche non salvate?"],
        "无法保存资料": ["es": "No se pudo guardar el perfil", "pt": "Não foi possível salvar o perfil", "fr": "Impossible d’enregistrer le profil", "ja": "プロフィールを保存できませんでした", "ko": "프로필을 저장할 수 없음", "it": "Impossibile salvare il profilo"],
        "星座": ["es": "Signo zodiacal", "pt": "Signo", "fr": "Signe astrologique", "ja": "星座", "ko": "별자리", "it": "Segno zodiacale"],
        "未填写": ["es": "Sin completar", "pt": "Não preenchido", "fr": "Non renseigné", "ja": "未入力", "ko": "입력하지 않음", "it": "Non compilato"],
        "未满1岁": ["es": "Menos de 1 año", "pt": "Menos de 1 ano", "fr": "Moins d’un an", "ja": "1歳未満", "ko": "1세 미만", "it": "Meno di 1 anno"],
        "不满1岁": ["es": "Menos de 1 año", "pt": "Menos de 1 ano", "fr": "Moins d’un an", "ja": "1歳未満", "ko": "1세 미만", "it": "Meno di 1 anno"],
        "未知年龄": ["es": "Edad desconocida", "pt": "Idade desconhecida", "fr": "Âge inconnu", "ja": "年齢不明", "ko": "나이 알 수 없음", "it": "Età sconosciuta"],
        "椰子资产与心愿": ["es": "Cocos y deseos", "pt": "Cocos e desejos", "fr": "Noix de coco et souhaits", "ja": "ココナッツとウィッシュ", "ko": "코코넛 및 소원", "it": "Noci di cocco e desideri"],
        "现居地": ["es": "Residencia", "pt": "Residência", "fr": "Lieu de résidence", "ja": "居住地", "ko": "거주지", "it": "Residenza"],
        "相处天数": ["es": "Días juntos", "pt": "Dias juntos", "fr": "Jours ensemble", "ja": "一緒に過ごした日数", "ko": "함께한 날", "it": "Giorni insieme"],
        "确认标记离世": ["es": "Confirmar estado conmemorativo", "pt": "Confirmar estado memorial", "fr": "Confirmer le statut commémoratif", "ja": "逝去の記録を確認", "ko": "추모 상태 확인", "it": "Conferma stato commemorativo"],
        "离世日期": ["es": "Fecha de fallecimiento", "pt": "Data de falecimento", "fr": "Date du décès", "ja": "逝去日", "ko": "별세일", "it": "Data del decesso"],
        "纪念模式": ["es": "Modo conmemorativo", "pt": "Modo memorial", "fr": "Mode commémoratif", "ja": "メモリアルモード", "ko": "추모 모드", "it": "Modalità commemorativa"],
        "继续编辑": ["es": "Seguir editando", "pt": "Continuar editando", "fr": "Continuer la modification", "ja": "編集を続ける", "ko": "계속 편집", "it": "Continua a modificare"],
        "编辑资料": ["es": "Editar perfil", "pt": "Editar perfil", "fr": "Modifier le profil", "ja": "プロフィールを編集", "ko": "프로필 편집", "it": "Modifica profilo"],
        "花费记录": ["es": "Gastos", "pt": "Despesas", "fr": "Dépenses", "ja": "支出記録", "ko": "지출 기록", "it": "Spese"],
        "血型": ["es": "Grupo sanguíneo", "pt": "Tipo sanguíneo", "fr": "Groupe sanguin", "ja": "血液型", "ko": "혈액형", "it": "Gruppo sanguigno"],
        "设置生日": ["es": "Añadir cumpleaños", "pt": "Adicionar aniversário", "fr": "Ajouter l’anniversaire", "ja": "誕生日を設定", "ko": "생일 설정", "it": "Aggiungi compleanno"],
        "资料已更新": ["es": "Perfil actualizado", "pt": "Perfil atualizado", "fr": "Profil mis à jour", "ja": "プロフィールを更新しました", "ko": "프로필이 업데이트됨", "it": "Profilo aggiornato"],
        "资料没有保存，请稍后再试。": ["es": "El perfil no se guardó. Inténtalo de nuevo.", "pt": "O perfil não foi salvo. Tente novamente.", "fr": "Le profil n’a pas été enregistré. Réessayez.", "ja": "プロフィールを保存できませんでした。もう一度お試しください。", "ko": "프로필이 저장되지 않았습니다. 다시 시도해 주세요.", "it": "Il profilo non è stato salvato. Riprova."],
        "身体资料": ["es": "Datos físicos", "pt": "Dados físicos", "fr": "Données physiques", "ja": "身体情報", "ko": "신체 정보", "it": "Dati fisici"],
        "身高": ["es": "Altura", "pt": "Altura", "fr": "Taille", "ja": "身長", "ko": "키", "it": "Altezza"],
        "输入名字后才能继续": ["es": "Introduce el nombre para continuar", "pt": "Digite o nome para continuar", "fr": "Saisissez le nom pour continuer", "ja": "続けるには名前を入力してください", "ko": "계속하려면 이름을 입력하세요", "it": "Inserisci il nome per continuare"],
        "运动记录": ["es": "Registros de ejercicio", "pt": "Registros de exercício", "fr": "Historique des activités", "ja": "運動記録", "ko": "운동 기록", "it": "Registri degli allenamenti"],
        "隐私": ["es": "Privacidad", "pt": "Privacidade", "fr": "Confidentialité", "ja": "プライバシー", "ko": "개인정보", "it": "Privacy"],
        "隐私设置": ["es": "Ajustes de privacidad", "pt": "Configurações de privacidade", "fr": "Réglages de confidentialité", "ja": "プライバシー設定", "ko": "개인정보 설정", "it": "Impostazioni privacy"],
        "隐私项目": ["es": "Campos privados", "pt": "Campos privados", "fr": "Champs privés", "ja": "非公開項目", "ko": "비공개 항목", "it": "Campi privati"],
        "PIN、公开/隐私": ["es": "PIN y visibilidad", "pt": "PIN e visibilidade", "fr": "PIN et visibilité", "ja": "PINと公開範囲", "ko": "PIN 및 공개 범위", "it": "PIN e visibilità"],
        "TSH、HbA1c、血压等": ["es": "TSH, HbA1c, presión arterial y más", "pt": "TSH, HbA1c, pressão arterial e mais", "fr": "TSH, HbA1c, tension et plus", "ja": "TSH、HbA1c、血圧など", "ko": "TSH, HbA1c, 혈압 등", "it": "TSH, HbA1c, pressione e altro"],
        "个人、伙伴与全岛进度": ["es": "Progreso personal, de compañeros y de la isla", "pt": "Progresso pessoal, de companheiros e da ilha", "fr": "Progression personnelle, des compagnons et de l’île", "ja": "個人・仲間・島の進捗", "ko": "개인, 동료 및 섬 진행도", "it": "Progressi personali, dei compagni e dell’isola"],
        "个人、伙伴与全岛里程碑": ["es": "Hitos personales, de compañeros y de la isla", "pt": "Marcos pessoais, de companheiros e da ilha", "fr": "Jalons personnels, des compagnons et de l’île", "ja": "個人・仲間・島のマイルストーン", "ko": "개인, 동료 및 섬 마일스톤", "it": "Traguardi personali, dei compagni e dell’isola"],
        "人类驾驶舱": ["es": "Centro humano", "pt": "Central humana", "fr": "Espace humain", "ja": "ヒューマンハブ", "ko": "휴먼 허브", "it": "Hub persone"],
        "仅本人可见": ["es": "Solo visible para esta persona", "pt": "Visível apenas para esta pessoa", "fr": "Visible uniquement par cette personne", "ja": "本人のみ表示", "ko": "본인에게만 표시", "it": "Visibile solo a questa persona"],
        "今日用药": ["es": "Medicación de hoy", "pt": "Medicação de hoje", "fr": "Médicaments du jour", "ja": "今日の服薬", "ko": "오늘의 복약", "it": "Farmaci di oggi"],
        "体检、检查和档案": ["es": "Revisiones, pruebas y archivos", "pt": "Consultas, exames e arquivos", "fr": "Bilans, examens et dossiers", "ja": "健診・検査・ファイル", "ko": "검진, 검사 및 파일", "it": "Controlli, esami e documenti"],
        "体检指标": ["es": "Indicadores clínicos", "pt": "Indicadores clínicos", "fr": "Indicateurs de santé", "ja": "健診指標", "ko": "검진 지표", "it": "Indicatori clinici"],
        "体重追踪": ["es": "Seguimiento del peso", "pt": "Acompanhamento de peso", "fr": "Suivi du poids", "ja": "体重トラッキング", "ko": "체중 추적", "it": "Monitoraggio del peso"],
        "健康报告": ["es": "Informes de salud", "pt": "Relatórios de saúde", "fr": "Rapports de santé", "ja": "健康レポート", "ko": "건강 보고서", "it": "Rapporti sulla salute"],
        "健康照护": ["es": "Salud y cuidados", "pt": "Saúde e cuidados", "fr": "Santé et soins", "ja": "健康とケア", "ko": "건강 및 돌봄", "it": "Salute e cura"],
        "已开启隐私的数据仅自己可见": ["es": "Los datos privados solo son visibles para esta persona", "pt": "Os dados privados só ficam visíveis para esta pessoa", "fr": "Les données privées ne sont visibles que par cette personne", "ja": "非公開データは本人のみ表示されます", "ko": "비공개 데이터는 본인에게만 표시됩니다", "it": "I dati privati sono visibili solo a questa persona"],
        "已设置": ["es": "Configurado", "pt": "Configurado", "fr": "Configuré", "ja": "設定済み", "ko": "설정됨", "it": "Configurato"],
        "年龄未知": ["es": "Edad desconocida", "pt": "Idade desconhecida", "fr": "Âge inconnu", "ja": "年齢不明", "ko": "나이 알 수 없음", "it": "Età sconosciuta"],
        "快速记录一次体重": ["es": "Añadir un peso rápido", "pt": "Adicionar peso rapidamente", "fr": "Ajouter rapidement un poids", "ja": "体重をすばやく記録", "ko": "체중 빠르게 기록", "it": "Registra rapidamente il peso"],
        "愿望清单和资产": ["es": "Lista de deseos y recompensas", "pt": "Lista de desejos e recompensas", "fr": "Liste de souhaits et récompenses", "ja": "ウィッシュリストと報酬", "ko": "위시리스트 및 보상", "it": "Lista desideri e premi"],
        "成员摘要": ["es": "Resumen del miembro", "pt": "Resumo do membro", "fr": "Résumé du membre", "ja": "メンバー概要", "ko": "구성원 요약", "it": "Riepilogo del membro"],
        "成就": ["es": "Logros", "pt": "Conquistas", "fr": "Succès", "ja": "実績", "ko": "업적", "it": "Obiettivi"],
        "成长": ["es": "Crecimiento", "pt": "Crescimento", "fr": "Progression", "ja": "成長", "ko": "성장", "it": "Crescita"],
        "按需记录": ["es": "Según sea necesario", "pt": "Quando necessário", "fr": "Selon les besoins", "ja": "必要に応じて記録", "ko": "필요할 때 기록", "it": "Quando necessario"],
        "无": ["es": "Ninguno", "pt": "Nenhum", "fr": "Aucun", "ja": "なし", "ko": "없음", "it": "Nessuno"],
        "昨天": ["es": "ayer", "pt": "ontem", "fr": "hier", "ja": "昨日", "ko": "어제", "it": "ieri"],
        "最近有记录": ["es": "Hay notas recientes", "pt": "Há notas recentes", "fr": "Notes récentes", "ja": "最近の記録あり", "ko": "최근 메모 있음", "it": "Note recenti"],
        "未记录": ["es": "Sin registros", "pt": "Sem registros", "fr": "Aucun enregistrement", "ja": "記録なし", "ko": "기록 없음", "it": "Nessun dato"],
        "未追踪": ["es": "Sin seguimiento", "pt": "Não monitorado", "fr": "Non suivi", "ja": "未追跡", "ko": "추적하지 않음", "it": "Non monitorato"],
        "查看": ["es": "Ver", "pt": "Ver", "fr": "Voir", "ja": "表示", "ko": "보기", "it": "Apri"],
        "椰子资产": ["es": "Cocos", "pt": "Cocos", "fr": "Noix de coco", "ja": "ココナッツ", "ko": "코코넛", "it": "Noci di cocco"],
        "添加药物和提醒": ["es": "Añadir medicación y recordatorios", "pt": "Adicionar medicação e lembretes", "fr": "Ajouter des médicaments et rappels", "ja": "薬とリマインダーを追加", "ko": "약과 알림 추가", "it": "Aggiungi farmaci e promemoria"],
        "用药和检查": ["es": "Medicación y revisiones", "pt": "Medicação e exames", "fr": "Médicaments et examens", "ja": "服薬と検査", "ko": "복약 및 검사", "it": "Farmaci e controlli"],
        "纪念模式 · 只读": ["es": "Modo conmemorativo · Solo lectura", "pt": "Modo memorial · Somente leitura", "fr": "Mode commémoratif · Lecture seule", "ja": "メモリアルモード・読み取り専用", "ko": "추모 모드 · 읽기 전용", "it": "Modalità commemorativa · Solo lettura"],
        "花费、心愿和记录": ["es": "Gastos, deseos y notas", "pt": "Despesas, desejos e notas", "fr": "Dépenses, souhaits et notes", "ja": "支出・ウィッシュ・記録", "ko": "지출, 소원 및 기록", "it": "Spese, desideri e note"],
        "记录今天的一句话": ["es": "Guardar una nota rápida", "pt": "Salvar uma nota rápida", "fr": "Enregistrer une note rapide", "ja": "短いメモを保存", "ko": "간단한 메모 저장", "it": "Salva una nota rapida"],
        "记录运动和共同健康": ["es": "Registrar movimiento y bienestar compartido", "pt": "Registrar movimento e bem-estar compartilhado", "fr": "Suivre l’activité et le bien-être partagé", "ja": "運動と共同の健康を記録", "ko": "운동과 공동 건강 기록", "it": "Registra attività e benessere condiviso"],
        "记录这个月花了什么": ["es": "Registrar los gastos de este mes", "pt": "Registrar os gastos deste mês", "fr": "Suivre les dépenses du mois", "ja": "今月の支出を記録", "ko": "이번 달 지출 기록", "it": "Registra le spese del mese"],
        "财务备注": ["es": "Finanzas y notas", "pt": "Finanças e notas", "fr": "Finances et notes", "ja": "家計とメモ", "ko": "재정 및 메모", "it": "Finanze e note"],
        "资料与家庭角色": ["es": "Perfil y rol en el hogar", "pt": "Perfil e papel na família", "fr": "Profil et rôle dans le foyer", "ja": "プロフィールと家族での役割", "ko": "프로필 및 가족 역할", "it": "Profilo e ruolo familiare"],
        "身份、资料与本地隐私": ["es": "Identidad, perfil y privacidad local", "pt": "Identidade, perfil e privacidade local", "fr": "Identité, profil et confidentialité locale", "ja": "本人情報・プロフィール・ローカルプライバシー", "ko": "신원, 프로필 및 로컬 개인정보", "it": "Identità, profilo e privacy locale"],
        "成员资料": ["es": "Perfil del miembro", "pt": "Perfil do membro", "fr": "Profil du membre", "ja": "メンバープロフィール", "ko": "구성원 프로필", "it": "Profilo del membro"],
        "资料可用": ["es": "Perfil disponible", "pt": "Perfil disponível", "fr": "Profil disponible", "ja": "プロフィール利用可能", "ko": "프로필 사용 가능", "it": "Profilo disponibile"],
        "趋势、指标和报告": ["es": "Tendencias, indicadores e informes", "pt": "Tendências, indicadores e relatórios", "fr": "Tendances, indicateurs et rapports", "ja": "傾向・指標・レポート", "ko": "추세, 지표 및 보고서", "it": "Tendenze, indicatori e rapporti"],
        "身份、头像、隐私": ["es": "Identidad, avatar y privacidad", "pt": "Identidade, avatar e privacidade", "fr": "Identité, avatar et confidentialité", "ja": "本人情報・アバター・プライバシー", "ko": "신원, 아바타 및 개인정보", "it": "Identità, avatar e privacy"],
        "身体状态": ["es": "Estado físico", "pt": "Estado físico", "fr": "État physique", "ja": "身体状態", "ko": "신체 상태", "it": "Stato fisico"],
        "锁定": ["es": "Bloqueado", "pt": "Bloqueado", "fr": "Verrouillé", "ja": "ロック中", "ko": "잠김", "it": "Bloccato"],
        "称呼与可选资料": ["es": "Nombre y datos opcionales", "pt": "Nome e dados opcionais", "fr": "Nom et informations facultatives", "ja": "名前と任意情報", "ko": "이름 및 선택 정보", "it": "Nome e dati facoltativi"],
        "地区": ["es": "Región", "pt": "Região", "fr": "Région", "ja": "地域", "ko": "지역", "it": "Regione"],
        "现居国家": ["es": "País de residencia", "pt": "País de residência", "fr": "Pays de résidence", "ja": "居住国", "ko": "거주 국가", "it": "Paese di residenza"],
        "个性与身体": ["es": "Personalidad y cuerpo", "pt": "Personalidade e corpo", "fr": "Personnalité et corps", "ja": "個性と身体", "ko": "개성 및 신체", "it": "Personalità e corpo"],
        "相册": ["es": "Fotos", "pt": "Fotos", "fr": "Photos", "ja": "写真", "ko": "사진", "it": "Foto"],
        "相机": ["es": "Cámara", "pt": "Câmera", "fr": "Appareil photo", "ja": "カメラ", "ko": "카메라", "it": "Fotocamera"],
        "打开中": ["es": "Abriendo", "pt": "Abrindo", "fr": "Ouverture", "ja": "開いています", "ko": "여는 중", "it": "Apertura"],
        "2.5D 头像开关": ["es": "Interruptor de avatar 2.5D", "pt": "Controle do avatar 2.5D", "fr": "Bouton d’avatar 2,5D", "ja": "2.5Dアバター切り替え", "ko": "2.5D 아바타 전환", "it": "Interruttore avatar 2,5D"],
        "不设置": ["es": "Omitir", "pt": "Pular", "fr": "Ignorer", "ja": "設定しない", "ko": "설정 안 함", "it": "Ignora"],
        "请选择": ["es": "Elegir", "pt": "Escolher", "fr": "Choisir", "ja": "選択", "ko": "선택", "it": "Scegli"]
    ]
    ...
    private static let curatedStaticTranslations: [String: [String: String]] = {
        ...
        for (key, translations) in curatedHumanProfileTranslations {
            values[key, default: [:]].merge(translations) { _, new in new }
        }
        return values
    }()
