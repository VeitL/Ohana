...
nonisolated enum CloudSyncEntityRegistry {
    ...
    static let descriptors: [CloudSyncEntityDescriptor] = [
        ...
        mutable(HumanHealthMetricLog.self),
        mutable(HumanHealthCondition.self),
        ...
        appendOnly(HumanHealthObservation.self),
    ...
    static let physicalDeletionOwnerships: [CloudSyncPhysicalDeletionOwnership] = [
        ...
        deletionOwnership(HumanHealthCondition.self, parent: .human, reason: "humanId"),
        deletionOwnership(HumanHealthObservation.self, parent: .human, reason: "humanId/conditionId"),
