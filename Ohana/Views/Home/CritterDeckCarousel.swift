        ...
        Button {
            ...
            VStack(spacing: 2) {
                ...
                Text(action.label)
                    ...
                    .foregroundStyle(isWaterDone ? Color.goLime : .white.opacity(0.85))
                    .lineLimit(1)
                Text(isWaterDone ? "已打卡" : action.sublabel)
                    .font(.system(size: 8, weight: .medium, design: .rounded))
                    .foregroundStyle(isWaterDone ? Color.goLime.opacity(0.7) : .white.opacity(0.4))
                    .lineLimit(1)
            }
            ...
            .overlay(RoundedRectangle(cornerRadius: 12, style: .continuous)
                .strokeBorder(isWaterDone ? Color.goLime.opacity(0.5) : accent.opacity(0.3), lineWidth: 1))
        }
        .buttonStyle(.plain)
    }
