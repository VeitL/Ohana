    ...
    var body: some View {
        NavigationStack {
            ZStack {
                ...
                // Animated Blobs
                ZStack {
                    Circle().fill(Color.goPrimary.opacity(0.4)).frame(width: 200).blur(radius: 60).offset(x: -80, y: -150)
                ...
                VStack {
                    ...
                    HStack(spacing: 8) {
                        ForEach(0..<cards.count, id: \.self) { i in
                            Circle()
                                .fill(i == currentIndex ? Color.goPrimary : Color.white.opacity(0.2))
                    ...
                    if index == 0 {
                        ...
                        HStack(spacing: 20) {
                            ...
                            VStack(alignment: .leading, spacing: 4) {
                                ...
                                Text("Perfect").font(OhanaFont.headline(.black)).foregroundStyle(Color.goPrimary)
                            }
                        }
                    } else if index == 1 {
                        // Health Content
                        VStack(spacing: 12) {
                            HStack {
                                ...
                                Spacer()
                                Text("Up to date").font(OhanaFont.caption(.bold)).foregroundStyle(Color.goPrimary).padding(.horizontal, 8).padding(.vertical, 4).background(Color.goPrimary.opacity(0.2), in: Capsule())
                            }
                            HStack {
