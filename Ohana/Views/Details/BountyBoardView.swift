    ...
    private func tabButton(label: String, idx: Int) -> some View {
        Button {
            ...
            Text(label)
                ...
                .background(selectedTab == idx ? Color.goPrimary : Color.white.opacity(0.08), in: Capsule())
        }
        .buttonStyle(.plain)
    }
        ...
        NavigationStack {
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    .foregroundStyle(title.isEmpty ? Color.goPrimary.opacity(0.3) : Color.goPrimary)
