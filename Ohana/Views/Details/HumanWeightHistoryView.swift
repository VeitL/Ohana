...
struct HumanWeightHistoryView: View {
    ...
    private func weightRow(log: HumanWeightLog) -> some View {
        HStack(spacing: 14) {
            Circle().fill(Color.goLime).frame(width: 8, height: 8)
        ...
        GeometryReader { geo in
            ...
            ZStack {
                ...
                if logs.count >= 2 {
                    ...
                    .fill(LinearGradient(
                        colors: [Color.goLime.opacity(0.35), Color.goLime.opacity(0)],
                    ...
                    .stroke(Color.goLime, style: StrokeStyle(lineWidth: 2.5, lineCap: .round))

                    ForEach(Array(logs.enumerated()), id: \.offset) { i, log in
                        Circle()
                            .fill(i == logs.count - 1 ? Color.goLime : Color.goLime.opacity(0.5))
