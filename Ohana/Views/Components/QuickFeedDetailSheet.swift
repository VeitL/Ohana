...
private enum ActiveFeedSheet: Identifiable, Equatable {
    case manual
    case treat
...
private enum FeedOverviewRange: String, CaseIterable, Identifiable {
    case days7
    case days30
    case days90
...
private struct FeedOverviewChartPoint: Identifiable {
    var id: TimeInterval { date.timeIntervalSinceReferenceDate }
    let date: Date
    let value: Double
}

private struct FeedPlanCalendarOccurrence: Identifiable {
...
private struct FeedPlanCalendarDaySummary: Identifiable {
    var id: TimeInterval { date.timeIntervalSinceReferenceDate }
    let date: Date
    let dayNumber: Int
...
private struct FeedPlanCalendarMarker: Identifiable {
    enum Status {
        case completed
        case missed
        case pending
...
private struct FeedPlanMonthlyCalendarView: View {
...
private struct FeedStockTrendPoint: Identifiable {
    let id = UUID()
    let date: Date
    let value: Double
...
private struct FeedTreatKindSummary: Identifiable {
...
private enum FeedInputField: Hashable {
    case manualGrams
    case treatGrams
    case planGrams
...
private struct CoreFoodCard: View {
    let title: String
    let value: String
    let subtitle: String
    let icon: String
...
private struct StockFoodCard: View {
    let title: String
...
private struct FeedingMetricPill: View {
    let title: String
    let value: String
    let tint: Color
...
private struct FoodPrimaryButton: View {
    let title: String
    let icon: String
    let tint: Color
    let action: () -> Void
...
private struct FeedingBowlIllustration: View {
    let progress: Double
    let tint: Color
...
private struct TreatCelebrationOverlay: View {
    let tint: Color
...
private struct ConditionalFeedGlassSurface: ViewModifier {
    let isEnabled: Bool
...
private enum FeedInlineSheetScrollCoordinateSpace {
    static let name = "FeedInlineSheetScrollCoordinateSpace"
}

private struct FeedInlineSheetScrollTopPreferenceKey: PreferenceKey {
...
private struct FeedScrollBounceConfigurator: UIViewRepresentable {
...
private enum FeedSheetGlassMode {
    case regular
    case clear
}

private struct FeedNativeSheetGlassSurface: View {
    let cornerRadius: CGFloat
...
private struct FeedInlineSheetGlassSurface: View {
    let cornerRadius: CGFloat
    let glassMode: FeedSheetGlassMode
