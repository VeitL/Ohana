...
struct ImageCutoutPreviewSheet: View {
    ...
    private func imageOptionCard(
        ...
        VStack(spacing: 10) {
            ...
            .background(
                isSelected ? Color.goLime.opacity(0.15) : Color.white.opacity(0.06),
            ...
            HStack(spacing: 5) {
                Image(systemName: icon)
                    ...
                    .foregroundStyle(isSelected ? Color.goLime : .white.opacity(0.6))
                Text(label)
                    .font(.system(size: 13, weight: .bold, design: .rounded))
                    .foregroundStyle(isSelected ? Color.goLime : .white)
            }
            Text(sublabel)
