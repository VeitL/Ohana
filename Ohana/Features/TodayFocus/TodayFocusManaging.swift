...
protocol TodayFocusManaging {
    ...
    func completeEvent(_ event: Event, on date: Date, context: ModelContext, executorId: String?) throws -> TodayFocusEventCompletionCommandResult
...
final class StaticTodayFocusManager: TodayFocusManaging {
    ...
    func completeEvent(_ event: Event, on date: Date, context: ModelContext, executorId: String?) throws -> TodayFocusEventCompletionCommandResult {
        try TodayFocusCommandService.completeEvent(event, on: date, context: context, executorId: executorId)
    }
