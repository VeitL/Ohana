...
struct PlantCareFeatureDetailView: View {
    ...
    var routeSnapshotRequest: PlantCareFeatureRouteSnapshotRequest {
    ...
    var showsFertilizingCadence: Bool {
    ...
    func matchesFocusedFeature(_ careType: PlantCareType) -> Bool {
