...
fake_cache_id="aaaaaaaaaaaaaaaa"
fake_cache_parent="${fixture_root}/cache"
fake_app="${fake_cache_parent}/Ohana-${fake_cache_id}/DerivedData/dogfood/Build/Products/Release-iphonesimulator/Ohana.app"
...
export OHANA_LOCAL_BUILD_CACHE_ID="${fake_cache_id}"
export OHANA_LOCAL_BUILD_CACHE_PARENT="${fake_cache_parent}"
