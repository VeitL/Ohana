...
> [`docs/archive/task-follow-ups-full-2026-06-25.md`](task-follow-ups-full-2026-06-25.md).
>
...
- Last compacted: 2026-07-09.
- Open follow-ups: 7 total: P1 = 5, P2 = 2, P3 = 0.
- Open P0: 0.
...
| External/manual validation | TFU-20260612-017, TFU-20260612-016, TFU-20260706-001, TFU-20260709-001 | Real iOS notification/UI/HealthKit behavior and the Solo Release P0/P1 path must be checked on device. Repo tests cannot close these alone. | Run GAP-9, GAP-6, Human Workout HealthKit, and Solo Release R1–R6 checks on a physical device. |
...
- Priority / bucket: P1, external/manual validation.
- Status: Open; the iPhone 17 simulator P0/P1 aggregate suite passed 93 tests with 0 failures, the current CI-equivalent `OhanaUnitTests` rerun passed 1,509 tests with 0 failures, the Solo Release whole-module-optimization simulator build passed after the latest fixes, and all full-scope audit/lint gates passed. The physical iPhone remained offline/unavailable on 2026-07-10, so no true-device or signed-Release result is asserted.
...
- TFU-20260612-022: Settings privacy/support actions closed locally on 2026-07-09. The source now exposes the public-policy HTTPS route and support mail route, with Settings UI/accessibility preflight passing; publication is verified when this batch reaches the public repository.
...
- TFU-20260611-001: App Store Connect privacy setup closed; the final Settings public-policy/support action closed locally under TFU-20260612-022 on 2026-07-09.
