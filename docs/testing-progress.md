...
- Current local validation: Plants shop decor expansion passed changed-file
  audits and targeted `PlantLaunchTests` / `HomeCommandExecutorTests` /
  `GachaSeriesCatalogTests` on the pinned `iPhone 17` destination.
