...
| GAP-2 回收站 | P0 上架前 | 🟢 | 成员+珍贵档案软删 30 天可恢复；流水直删但写 tombstone；涉及 schema 升版 | 待提交 | 开工：2026-06-12；门禁：`scripts/module-exit-gate.sh` PASS；自动验收通过，真实 UI 追踪项见 `docs/planning/gap-2-recycle-bin-acceptance-track-list.md`；schema 升至 `ArkSchemaV69`；commit 待提交 |
