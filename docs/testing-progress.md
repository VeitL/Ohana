...
If simulator services are unavailable, record that as an environment blocker.
...
| 5 | Home + TodayFocus + QuickCare | 🟢 | Home read-model refactor is in place; remaining Home item is P2 actor-isolation cleanup. |
...
| Home | TFU-20260623-001 | Actor-isolation cleanup for pure quick-action interaction helpers. |
