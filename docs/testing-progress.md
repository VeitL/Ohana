...
- Current local validation: Plants localization cleanup passed changed-file
  audits, localization coverage, targeted `PlantLaunchTests` /
  `LocalizationTests`, and `scripts/module-exit-gate.sh` on the pinned
