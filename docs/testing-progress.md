...
| Domain | 2 | 🟢 | 2026-06-12 | TFU-20260614-009 已本地修复待 CI + 全新纯复审；旧架构清理见 TFU-20260612-014 | `304971af` | 2026-06-14 当前代码首次 Domain 纯对抗复审（Codex，care-derivation/PhysicalDeletion/CloudSync 后）发现 P0=0 / P1=5 / P2=2，不能 🏁。同日 Codex Domain repair session 已本地修复五个 P1 与两个 P2，并通过 `scripts/module-exit-gate.sh`（841 unit tests + 3 UI template tests）及相关 targeted suites/audit fixture tests；仍需推送 CI 绿后另开全新纯复审，P0/P1=0 才能 🏁。 |
