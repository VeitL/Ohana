...
- Current local validation: Debug coconut balance entry passed changed-file
  audits, `git diff --check`, `scripts/build-debug-fast.sh`, and CI on the
  pinned `iPhone 17` destination.
