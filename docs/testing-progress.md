...
- Current local validation: Plants Today Focus aggregation passed changed-file
  audits, architecture boundary audit, targeted `PlantFeatureGateXCTests`,
  `OhanaTests`, and `HomeCommandExecutorTests` on the pinned `iPhone 17`
  destination.
