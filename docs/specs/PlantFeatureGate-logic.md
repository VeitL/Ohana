...
植物门与 `OnlineFeatureGate` 互不耦合：联机关闭不代表植物关闭，植物关闭也不代表联机关闭。基础植物照护永久免费且本地可用，只受椰子树成长节奏控制；Free 最多同时管理 5 株活跃植物，Personal 不限量。未来 Care+ 可在不改变基础免费闭环的前提下增加 AI 识别、病虫害智能诊断、天气联动和季节计划。
